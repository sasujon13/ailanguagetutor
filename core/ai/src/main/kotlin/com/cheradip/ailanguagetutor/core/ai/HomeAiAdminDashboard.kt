...
data class HomeAiAdminDashboard(
    ...
    val routesByIntent: Map<String, Int> = emptyMap(),
    val modelsUsed: Map<String, Int> = emptyMap(),
    val lastModelUsed: String? = null,
    val lastTranslationBackend: String? = null,
    val inferenceFallbackCount: Int = 0,
